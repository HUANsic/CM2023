...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_obj_set_style_text_font(ui->g_kb_screen, &lv_font_Alatsi_Regular_14, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style for screen_label_1, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_border_width(ui->screen_label_1, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_radius(ui->screen_label_1, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_text_color(ui->screen_label_1, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_label_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_text_color(ui->screen_label_speed, lv_color_hex(0xa8b2f1), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_color(ui->screen_label_speed, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style for screen_label_speed, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_border_width(ui->screen_label_speed, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_radius(ui->screen_label_speed, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_text_color(ui->screen_label_speed, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_label_speed, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	//Write style for screen_label_3, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_border_width(ui->screen_label_3, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_radius(ui->screen_label_3, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_text_color(ui->screen_label_3, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_label_3, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	//Write style for screen_label_pidgoal, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->screen_label_pidgoal, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_label_pidgoal, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_label_pidgoal, lv_color_hex(0x83fd84), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_color(ui->screen_label_pidgoal, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style for screen_label_pidgoal, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_border_width(ui->screen_label_pidgoal, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_radius(ui->screen_label_pidgoal, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_text_color(ui->screen_label_pidgoal, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_label_pidgoal, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	//Write style for screen_label_5, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_border_width(ui->screen_label_5, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_radius(ui->screen_label_5, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_text_color(ui->screen_label_5, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_label_5, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	//Write style for screen_label_stepcounter, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->screen_label_stepcounter, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->screen_label_stepcounter, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->screen_label_stepcounter, lv_color_hex(0xffcb80), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_color(ui->screen_label_stepcounter, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style for screen_label_stepcounter, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_border_width(ui->screen_label_stepcounter, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_radius(ui->screen_label_stepcounter, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_text_color(ui->screen_label_stepcounter, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_label_stepcounter, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_label_7, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style for screen_label_7, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_border_width(ui->screen_label_7, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_radius(ui->screen_label_7, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_text_color(ui->screen_label_7, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_label_7, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	//Write style for screen_sw_pid, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_sw_pid, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_sw_pid, lv_color_hex(0x484848), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style for screen_sw_pid, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
	lv_obj_set_style_bg_opa(ui->screen_sw_pid, 255, LV_PART_MAIN|LV_STATE_FOCUSED);
	lv_obj_set_style_bg_color(ui->screen_sw_pid, lv_color_hex(0x332a2a), LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	//Write style for screen_sw_pid, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_bg_opa(ui->screen_sw_pid, 255, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_bg_color(ui->screen_sw_pid, lv_color_hex(0x3d0707), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	//Write style for screen_sw_pid, Part: LV_PART_INDICATOR, State: LV_STATE_CHECKED.
	lv_obj_set_style_bg_opa(ui->screen_sw_pid, 255, LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_bg_color(ui->screen_sw_pid, lv_color_hex(0x2195f6), LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_border_width(ui->screen_sw_pid, 0, LV_PART_INDICATOR|LV_STATE_CHECKED);

	//Write style for screen_sw_pid, Part: LV_PART_KNOB, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_sw_pid, 255, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_sw_pid, lv_color_hex(0xffffff), LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_color(ui->screen_btn_go, lv_color_hex(0x0d9d0e), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style for screen_btn_go, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
	lv_obj_set_style_bg_opa(ui->screen_btn_go, 255, LV_PART_MAIN|LV_STATE_FOCUSED);
	lv_obj_set_style_bg_color(ui->screen_btn_go, lv_color_hex(0x2e532a), LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_go, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_FOCUSED);
	lv_obj_set_style_text_font(ui->screen_btn_go, &lv_font_Alatsi_Regular_25, LV_PART_MAIN|LV_STATE_FOCUSED);

	//Write style for screen_btn_go, Part: LV_PART_MAIN, State: LV_STATE_PRESSED.
	lv_obj_set_style_bg_opa(ui->screen_btn_go, 255, LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_bg_color(ui->screen_btn_go, lv_color_hex(0x70d766), LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_go, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_font(ui->screen_btn_go, &lv_font_Alatsi_Regular_25, LV_PART_MAIN|LV_STATE_PRESSED);

	//Write style for screen_btn_go, Part: LV_PART_MAIN, State: LV_STATE_CHECKED.
	lv_obj_set_style_bg_opa(ui->screen_btn_go, 255, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_bg_color(ui->screen_btn_go, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_go, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_font(ui->screen_btn_go, &lv_font_Alatsi_Regular_25, LV_PART_MAIN|LV_STATE_CHECKED);

	//Write style for screen_btn_go, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_bg_opa(ui->screen_btn_go, 255, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_bg_color(ui->screen_btn_go, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_go, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_label_set_text(ui->screen_label_8, "Kp=-4000.000");
	...
	//Write style for screen_label_8, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_border_width(ui->screen_label_8, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_radius(ui->screen_label_8, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_text_color(ui->screen_label_8, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_label_8, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_label_set_long_mode(ui->screen_btn_add_label, LV_LABEL_LONG_WRAP);
	...
	//Write style for screen_btn_add, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_btn_add, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_btn_add, lv_color_hex(0x343434), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->screen_btn_add, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style for screen_btn_add, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
	lv_obj_set_style_bg_opa(ui->screen_btn_add, 255, LV_PART_MAIN|LV_STATE_FOCUSED);
	lv_obj_set_style_bg_color(ui->screen_btn_add, lv_color_hex(0x35414a), LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_add, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_FOCUSED);
	lv_obj_set_style_text_font(ui->screen_btn_add, &lv_font_Alatsi_Regular_14, LV_PART_MAIN|LV_STATE_FOCUSED);

	//Write style for screen_btn_add, Part: LV_PART_MAIN, State: LV_STATE_PRESSED.
	lv_obj_set_style_bg_opa(ui->screen_btn_add, 255, LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_bg_color(ui->screen_btn_add, lv_color_hex(0x4f4f4f), LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_add, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_font(ui->screen_btn_add, &lv_font_Alatsi_Regular_14, LV_PART_MAIN|LV_STATE_PRESSED);

	//Write style for screen_btn_add, Part: LV_PART_MAIN, State: LV_STATE_CHECKED.
	lv_obj_set_style_bg_opa(ui->screen_btn_add, 255, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_bg_color(ui->screen_btn_add, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_add, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_font(ui->screen_btn_add, &lv_font_Alatsi_Regular_14, LV_PART_MAIN|LV_STATE_CHECKED);

	//Write style for screen_btn_add, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_bg_opa(ui->screen_btn_add, 255, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_bg_color(ui->screen_btn_add, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_add, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	//Write style for screen_adjstep_list, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_text_color(ui->screen_adjstep_list, lv_color_hex(0x0D3055), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_border_color(ui->screen_adjstep_list, lv_color_hex(0xe1e6ee), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_bg_color(ui->screen_adjstep_list, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->screen_adjstep_list, 0, LV_PART_MAIN|LV_STATE_DEFAULT);

	//Write style for screen_adjstep_list, Part: LV_PART_MAIN, State: LV_STATE_CHECKED.
	lv_obj_set_style_text_color(ui->screen_adjstep_list, lv_color_hex(0x0D3055), LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_style_border_color(ui->screen_adjstep_list, lv_color_hex(0xe1e6ee), LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_style_bg_color(ui->screen_adjstep_list, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_shadow_width(ui->screen_adjstep_list, 0, LV_PART_MAIN|LV_STATE_CHECKED);

	//Write style for screen_adjstep_list, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
	lv_obj_set_style_text_color(ui->screen_adjstep_list, lv_color_hex(0x0D3055), LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	lv_obj_set_style_border_color(ui->screen_adjstep_list, lv_color_hex(0xe1e6ee), LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	lv_obj_set_style_bg_color(ui->screen_adjstep_list, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_FOCUSED);
	lv_obj_set_style_shadow_width(ui->screen_adjstep_list, 0, LV_PART_MAIN|LV_STATE_FOCUSED);

	//Write style for screen_adjstep_list, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_text_color(ui->screen_adjstep_list, lv_color_hex(0x0D3055), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_border_color(ui->screen_adjstep_list, lv_color_hex(0xe1e6ee), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_adjstep_list, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_shadow_width(ui->screen_adjstep_list, 0, LV_PART_MAIN|LV_STATE_DISABLED);

	//Write style state: LV_STATE_CHECKED for &style_screen_adjstep_list_extra_list_selected_checked
	...
	lv_style_set_text_color(&style_screen_adjstep_list_extra_list_selected_checked, lv_color_hex(0xffffff));
	...
	lv_style_set_border_color(&style_screen_adjstep_list_extra_list_selected_checked, lv_color_hex(0xe1e6ee));
	...
	lv_style_set_bg_color(&style_screen_adjstep_list_extra_list_selected_checked, lv_color_hex(0x00a1b5));
	...
	//Write style state: LV_STATE_DEFAULT for &style_screen_adjstep_list_extra_list_main_default
	...
	lv_style_set_text_color(&style_screen_adjstep_list_extra_list_main_default, lv_color_hex(0x0D3055));
	...
	lv_style_set_border_color(&style_screen_adjstep_list_extra_list_main_default, lv_color_hex(0xe1e6ee));
	...
	lv_style_set_bg_color(&style_screen_adjstep_list_extra_list_main_default, lv_color_hex(0xffffff));
	...
	//Write style state: LV_STATE_DEFAULT for &style_screen_adjstep_list_extra_list_scrollbar_default
	...
	lv_style_set_bg_color(&style_screen_adjstep_list_extra_list_scrollbar_default, lv_color_hex(0x00ff00));
	...
	//Write style for screen_label_9, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_border_width(ui->screen_label_9, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_radius(ui->screen_label_9, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_text_color(ui->screen_label_9, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_label_9, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_label_set_long_mode(ui->screen_btn_sub_label, LV_LABEL_LONG_WRAP);
	...
	//Write style for screen_btn_sub, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_btn_sub, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_btn_sub, lv_color_hex(0x343434), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->screen_btn_sub, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style for screen_btn_sub, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
	lv_obj_set_style_bg_opa(ui->screen_btn_sub, 255, LV_PART_MAIN|LV_STATE_FOCUSED);
	lv_obj_set_style_bg_color(ui->screen_btn_sub, lv_color_hex(0x35414a), LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_sub, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_FOCUSED);
	lv_obj_set_style_text_font(ui->screen_btn_sub, &lv_font_Alatsi_Regular_14, LV_PART_MAIN|LV_STATE_FOCUSED);

	//Write style for screen_btn_sub, Part: LV_PART_MAIN, State: LV_STATE_PRESSED.
	lv_obj_set_style_bg_opa(ui->screen_btn_sub, 255, LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_bg_color(ui->screen_btn_sub, lv_color_hex(0x4f4f4f), LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_sub, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_font(ui->screen_btn_sub, &lv_font_Alatsi_Regular_14, LV_PART_MAIN|LV_STATE_PRESSED);

	//Write style for screen_btn_sub, Part: LV_PART_MAIN, State: LV_STATE_CHECKED.
	lv_obj_set_style_bg_opa(ui->screen_btn_sub, 255, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_bg_color(ui->screen_btn_sub, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_sub, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_font(ui->screen_btn_sub, &lv_font_Alatsi_Regular_14, LV_PART_MAIN|LV_STATE_CHECKED);

	//Write style for screen_btn_sub, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_bg_opa(ui->screen_btn_sub, 255, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_bg_color(ui->screen_btn_sub, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_sub, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_label_set_long_mode(ui->screen_btn_next_label, LV_LABEL_LONG_WRAP);
	...
	//Write style for screen_btn_next, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_btn_next, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_btn_next, lv_color_hex(0x343434), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_color(ui->screen_btn_next, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style for screen_btn_next, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
	lv_obj_set_style_bg_opa(ui->screen_btn_next, 255, LV_PART_MAIN|LV_STATE_FOCUSED);
	lv_obj_set_style_bg_color(ui->screen_btn_next, lv_color_hex(0x35414a), LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_next, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_FOCUSED);
	lv_obj_set_style_text_font(ui->screen_btn_next, &lv_font_Alatsi_Regular_14, LV_PART_MAIN|LV_STATE_FOCUSED);

	//Write style for screen_btn_next, Part: LV_PART_MAIN, State: LV_STATE_PRESSED.
	lv_obj_set_style_bg_opa(ui->screen_btn_next, 255, LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_bg_color(ui->screen_btn_next, lv_color_hex(0x4f4f4f), LV_PART_MAIN|LV_STATE_PRESSED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_next, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_PRESSED);
	lv_obj_set_style_text_font(ui->screen_btn_next, &lv_font_Alatsi_Regular_14, LV_PART_MAIN|LV_STATE_PRESSED);

	//Write style for screen_btn_next, Part: LV_PART_MAIN, State: LV_STATE_CHECKED.
	lv_obj_set_style_bg_opa(ui->screen_btn_next, 255, LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_bg_color(ui->screen_btn_next, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_next, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_CHECKED);
	lv_obj_set_style_text_font(ui->screen_btn_next, &lv_font_Alatsi_Regular_14, LV_PART_MAIN|LV_STATE_CHECKED);

	//Write style for screen_btn_next, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_bg_opa(ui->screen_btn_next, 255, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_bg_color(ui->screen_btn_next, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_text_color(ui->screen_btn_next, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	//Write style for screen_sw_disarm, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_sw_disarm, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_sw_disarm, lv_color_hex(0x484848), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	//Write style for screen_sw_disarm, Part: LV_PART_MAIN, State: LV_STATE_FOCUSED.
	lv_obj_set_style_bg_opa(ui->screen_sw_disarm, 255, LV_PART_MAIN|LV_STATE_FOCUSED);
	lv_obj_set_style_bg_color(ui->screen_sw_disarm, lv_color_hex(0x332a2a), LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	//Write style for screen_sw_disarm, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_bg_opa(ui->screen_sw_disarm, 255, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_bg_color(ui->screen_sw_disarm, lv_color_hex(0x3d0707), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	//Write style for screen_sw_disarm, Part: LV_PART_INDICATOR, State: LV_STATE_CHECKED.
	lv_obj_set_style_bg_opa(ui->screen_sw_disarm, 255, LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_bg_color(ui->screen_sw_disarm, lv_color_hex(0x2195f6), LV_PART_INDICATOR|LV_STATE_CHECKED);
	lv_obj_set_style_border_width(ui->screen_sw_disarm, 0, LV_PART_INDICATOR|LV_STATE_CHECKED);

	//Write style for screen_sw_disarm, Part: LV_PART_KNOB, State: LV_STATE_DEFAULT.
	lv_obj_set_style_bg_opa(ui->screen_sw_disarm, 255, LV_PART_KNOB|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_color(ui->screen_sw_disarm, lv_color_hex(0xffffff), LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	//Write style for screen_label_10, Part: LV_PART_MAIN, State: LV_STATE_DISABLED.
	lv_obj_set_style_border_width(ui->screen_label_10, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_radius(ui->screen_label_10, 0, LV_PART_MAIN|LV_STATE_DISABLED);
	lv_obj_set_style_text_color(ui->screen_label_10, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_bg_color(ui->screen_label_10, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DISABLED);
